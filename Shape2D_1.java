...
abstract class Shape{
    String id;
    // 有 abstract的 function一定要修改才能繼承他
    // 虛擬(抽象)類別 (只能extends 不能new的類別), 拿來extend後要滿足虛擬類別中的abstract method
    // 虛擬 method故 extends後需要完成這兩個 method
...
// Circle Square Triangle Rectangle分別繼承於 Shape
// 並定義各自之 length, area function
